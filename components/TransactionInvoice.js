          ...
          <View style={{flex:1, backgroundColor: '#ffffff'}}>
           ...
           <View style={{flex:90}}>
            ...
            <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', paddingVertical: 10}}>
              <View>
                <Text style={{color: '#5D7889'}}>Total {dataLength} Items</Text>
                <Text style={{color: '#5D7889'}}>Discount on MRP Rs.<Text style={{color: '#5D7889',fontWeight: 'bold'}}>40</Text></Text>
              </View>
                <Text style={{color: '#5D7889'}}>Sub Total</Text>
                <Text style={{color: '#5D7889'}}>Rs.40</Text>
            </View>
           </View>
         </View>
